...
export class ReviewsComponent implements OnInit {
  ...
  cols = ['name', 'rating', 'featured', 'actions'];
  loading = false;
  ...
  openForm(item?: ReviewResponse) {
    ...
    if (item) { this.form.patchValue({ name: item.name, designation: item.designation, rating: item.rating, description: item.description, isFeatured: item.isFeatured }); }
    else { this.form.reset({ isFeatured: false }); }
  }
